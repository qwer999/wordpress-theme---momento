...
/**
 * 1eftHander, 2012-09-03, 사용자 정의 필드를 활용한 배경화면 바꾸기
 * @since Twenty Eleven 1.0
 */
function custom_field_background_image( $post_id, $repeat ) {
    $meta_values = get_post_meta($post_id, 'Background Image', true);
    if ( '' != $meta_values ) {
        echo '<style type="text/css">';
        echo '  body {';
        echo '    background: #1D1D1D;';
        echo '    color: #BBB;';
        echo '    background-image: url('.$meta_values.');';
        if ( !$repeat ) {
